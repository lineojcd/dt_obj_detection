...
class Wrapper:
    def __init__(self):
        ...
        self.model = Model()
        self.model.load_state_dict(torch.load("weights/faster_rcnn_resnet50_sgd_epoch8.ckpt", map_location=self.device))
...
class Model(torch.nn.Module):
    def __init__(self, num_class=5):
        ...
        self.model.roi_heads.box_predictor = FastRCNNPredictor(in_features, num_class)
